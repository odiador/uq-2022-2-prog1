 ...
 * Crear una función que genere un vector con los estudiantes que perdieron una asignatura
 */
public class p22b {
	public static void main (String args[]) {
		...
		String arr[] = perdieronUna(estudiantes, calculo, algebraLineal, programacion, electronica);
		cial.imprimir("Las personas que solo perdieron 1 materia fueron:\n"+cial.arregloSaString(arr));
	}
	...
	public static String[] generarArrPerdieron1 (String[] arrSinR, int[] arrFrec) {
		String res = "";
		for (int i = 0;i<arrSinR.length;i++) {
			if(arrFrec[i]==1) res += arrSinR[i]+"-";
		}
		String arrRes[] = res.split("-");
		return arrRes;
	}
	...
	public static String[] perdieronUna(String[] estudiantes, String[] calculo,
		...
		String arrRes[] = generarArrPerdieron1(arrSinR,arrFrec);
