 ...
 * Crear una función que genere un vector con los estudiantes que perdieron dos asignaturas
 */
public class p22c {
	public static void main (String args[]) {
		...
		String arr[] = perdieron2(estudiantes, calculo, algebraLineal, programacion, electronica);
		cial.imprimir("Las personas que perdieron 2 materias fueron:\n"+cial.arregloSaString(arr));
	}
	...
	public static String[] generarArrPerdieron2 (String[] arrSinR, int[] arrFrec) {
		String res = "";
		for (int i = 0;i<arrSinR.length;i++) {
			if(arrFrec[i]==2) res += arrSinR[i]+"-";
		}
		String arrRes[] = res.split("-");
		return arrRes;
	}
	public static String[] perdieron2(String[] estudiantes, String[] calculo,
		...
		String arrRes[] = generarArrPerdieron2(arrSinR,arrFrec);
